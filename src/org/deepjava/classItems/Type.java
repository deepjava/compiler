...
import org.deepjava.dwarf.die.TypeDIE;
...
public class Type extends Item {
	...
	protected static void setUpBaseTypeTable(){
		...
		registerWellKnownClasses(txKernel, "org/deepjava/runtime/Kernel");
	 ...
	 */
	public static Type getTypeByDescriptor(HString typeDesc) {
