...
import org.deepjava.eclipse.ui.model.TaskObject;
...
public class TaskView extends ViewPart implements ICdescAndTypeConsts, ICclassFileConsts{
	...
	private void getContent() {
		...
		try{
			...
			Class taskCls = (Class)RefType.refTypeList.getItemByName("org/deepjava/runtime/ppc32/Task");
			if (taskCls == null) taskCls = (Class)RefType.refTypeList.getItemByName("org/deepjava/runtime/arm32/Task");
