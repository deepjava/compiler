...
public class Dyadic extends SSAInstruction {
	...
	public String toString(){
		...
		sb.append(result.n + ": ");
		sb.append("Dyadic["+ scMnemonics[ssaOpcode]+"] {"+ operands[0].n + ", " + operands[1].n + "}");
		...
		if (result.regLong >= 0) sb.append(", regLong=" + result.regLong);
		if (result.reg >= 0) sb.append(", reg=" + result.reg);
