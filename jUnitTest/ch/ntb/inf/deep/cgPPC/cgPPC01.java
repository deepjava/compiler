...
//	@Ignore
	...
	public void simple6() {
		...
		assertEquals("wrong instruction", InstructionDecoder.getCode("lfs  fr1, 24(r2)"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("li  r2, 3"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("addis  r2, r2, 0"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("lfd  fr1, 24(r2)"), code[i++]);
