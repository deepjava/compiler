...
//	@Ignore
	...
	public void classMethCall() {
		...
		assertEquals("wrong instruction", InstructionDecoder.getCode("addi  r2, r2, 100"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("extsb  r2, r2"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("li  r3, 12"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("addis  r3, r3, 0"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("stb  r2, 4(r3)"), code[i++]);
...
//	@Ignore
	...
	public void classMethod() {
		...
		assertEquals("wrong instruction", InstructionDecoder.getCode("cmp crf0, 0, r29, r31"), code[i++]);
	...
	public void objectMethod() {
		...
		assertEquals("wrong instruction", InstructionDecoder.getCode("addi  r2, r2, 200"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("extsh  r2, r2"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("twi  ifequal, r31, 0"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("sth  r2, 6(r31)"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("li  r2, 0"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("addis  r2, r2, 0"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("lbz  r2, 4(r2)"), code[i++]);
		assertEquals("wrong instruction", InstructionDecoder.getCode("extsb  r2, r2"), code[i++]);
