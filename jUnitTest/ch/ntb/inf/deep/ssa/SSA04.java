...
public class SSA04 extends TestSSA {
	...
	public void testWhile1(){
		...
		testNode(nodes[2], 1, 1, 3);
		testNode(nodes[3], 0, 0, 3);
	}
	...
	public void testFor1(){
		...
		testNode(nodes[2], 1, 2, 4);
		testNode(nodes[3], 0, 0, 4);
	}
	...
	public void testForWhile(){
		...
		testNode(nodes[2], 1, 1, 5);
		testNode(nodes[3], 2, 0, 5);
		testNode(nodes[4], 0, 1, 5);
		testNode(nodes[5], 0, 0, 5);
	}
	...
	public void testForIfWhile(){
		...
		testNode(nodes[2], 0, 0, 4);
		testNode(nodes[3], 2, 0, 4);
		testNode(nodes[4], 1, 1, 4);
		testNode(nodes[5], 2, 2, 4);
		testNode(nodes[6], 1, 1, 4);
		testNode(nodes[7], 0, 0, 4);
	}
}
